...
{
    "name": "WooCommerce Connector - Two-Way Sync",
    "version": "19.0.1.0.0",
    "category": "Sales/Sales",
    "summary": "Bidirectional WooCommerce sync: products, stock, prices, "
               "customers, orders & shipments. Webhook-driven inbound, queued "
